...
class CoverageRatchetCommand(Command):
    ...
    def run(self) -> None:
        ...
        if new_coverage < high_water_mark:
            raise Exception("{} coverage used to be {}; " "down to {}%.  Fix by viewing '{}'".format(self.type_of_coverage, high_water_mark, new_coverage, self.coverage_url))
...
class TestCoverageRatchetCommand(CoverageRatchetCommand):
    def initialize_options(self) -> None:
        ...
        self.coverage_file = os.path.join(os.path.dirname(os.path.abspath(__file__)), "metrics", "coverage_high_water_mark")
...
setup(
    ...
    """,
    install_requires=["vertica_python"],
    cmdclass={
